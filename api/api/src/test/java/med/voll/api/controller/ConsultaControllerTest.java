...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("DEberia retornar estado 200 cuando los datos ingresados sean validos")
    @WithMockUser
    void agendarEscenario2() throws Exception {
        ...
        //given   //when
        when(service.agendar(any())).thenReturn(datos);

        var response = mvc.perform(post("/consultas")
                .contentType(MediaType.APPLICATION_JSON)
                .content(datosAgendarConsultaJacksonTester.write(new DatosAgendarConsulta(2l, 5l, fecha, especialidad)).getJson())
