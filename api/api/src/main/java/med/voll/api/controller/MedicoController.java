...
public class MedicoController {
    ...
    public ResponseEntity<Page<DatosListadoMedico>> listadoMedico(@PageableDefault(size = 2) Pageable pageable){
    ...
    @Transactional
    public void eliminarMedico(@PathVariable Long id){ //Para decir que viene del path
